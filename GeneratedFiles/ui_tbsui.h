...
public:
    ...
    void setupUi(QDialog *tbsui)
    {
        ...
        lin_Fre_0->setEchoMode(QLineEdit::Normal);
        lin_Fre_0->setCursorPosition(0);
        lin_Fre_0->setDragEnabled(false);
        ...
        gridLayout_3->addWidget(che_Rst, 12, 0, 1, 3);
...
"kbps):", nullptr));
...
#ifndef QT_NO_ACCESSIBILITY
        lin_Fre_0->setAccessibleName(QString());
#endif // QT_NO_ACCESSIBILITY
        lin_Fre_0->setText(QString());
        ...
        label_8->setText(QApplication::translate("tbsui", "Level (-35~0dBm):", nullptr));
