...
void IconHelper::setStyle(QWidget *widget, const QString &type, int borderWidth,
...
void IconHelper::setStyle(
    QWidget *widget, QList<QToolButton *> btns, QList<int> pixChar,
  ...
  qss.append(QString("QWidget>QToolButton{background-color:%1;color:%2;}")
                 ...
                 .arg(normalTextColor));
  qss.append(
      QString("QWidget>QToolButton:hover,QWidget>QToolButton:pressed,QWidget>"
  ...
  for (int i = 0; i < btnCount; i++) {
    ...
    QPixmap pixDark = getPixmap(darkTextColor, QChar(pixChar.at(i)), iconSize,
...
void IconHelper::setStyle(QFrame *frame, QList<QToolButton *> btns,
                          QList<int> pixChar, quint32 iconSize,
                          quint32 iconWidth, quint32 iconHeight,
                          const QString &normalBgColor,
                          const QString &darkBgColor,
                          const QString &normalTextColor,
                          const QString &darkTextColor) {
  ...
  qss.append(QString("QFrame>QToolButton{background-color:%1;color:%2;}")
                 ...
                 .arg(normalTextColor));
  qss.append(
      QString("QFrame>QToolButton:hover,QFrame>QToolButton:pressed,QFrame>"
              "QToolButton:checked{background-color:%1;color:%2;}")
          .arg(darkBgColor)
          .arg(darkTextColor));
